...
use App\Adapters\Presenters\Library\ListLoansByAuthorJsonPresenter;
...
use App\Core\Domain\Library\Ports\UseCases\ListLoansByAuthor\ListLoansByAuthorUseCase;
...
use App\Core\Services\Library\ListLoansByAuthorService;
...
use App\Http\Controllers\ListLoansByAuthorController;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function libraryDependencies()
    {
        ...
        $this->app
            ->when(ListLoansByAuthorController::class)
            ->needs(ListLoansByAuthorUseCase::class)
            ->give(
                fn($app) => $app->make(ListLoansByAuthorService::class, [
                    "output" => $app->make(ListLoansByAuthorJsonPresenter::class),
                ]),
            );
        ...
        $this->app
            ...
            ->give(
                fn($app) => $app->make(ListLoansByBookService::class, [
